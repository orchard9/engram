...
impl ConsolidationEngine {
    ...
    pub fn ripple_replay(&mut self, episodes: &[Episode]) {
        ...
        self.stats.average_replay_speed = self.stats.average_replay_speed.mul_add(
            (self.stats.total_replays - 1) as f32,
            replay_event.speed_multiplier,
        ) / self.stats.total_replays as f32;
    }
    ...
    pub fn get_consolidation_progress(&self, episode: &Episode) -> f32 {
        if let Some(_pattern) = self.find_matching_pattern(episode) {
