...
pub fn run_validation(c: &mut Criterion) {
    c.bench_function("ann_validation_faiss_vs_engram", |b| {
        b.iter(|| {
            let dataset = DatasetLoader::generate_synthetic(1_000, 50);
...
#[cfg(feature = "ann_benchmarks")]
criterion::criterion_group!(ann_validation, run_validation);
#[cfg(feature = "ann_benchmarks")]
criterion::criterion_main!(ann_validation);
